"""Scraper for clemfoodie.com"""
from base_scraper import BaseScraper
from typing import Dict, List


class ClemfoodieScraper(BaseScraper):
    """Scraper for Clem Foodie."""

    def __init__(self):
        super().__init__(
            base_url="https://clemfoodie.com/category/recettes/",
            name="Clem Foodie"
        )
    ...
    def scrape_category(self, category_url: str, max_recipes: int = 1000, max_pages: int = 100) -> List[Dict]:
