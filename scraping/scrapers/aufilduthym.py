"""Scraper for aufilduthym.fr"""
from base_scraper import BaseScraper
from typing import Dict, List


class AufilduthymScraper(BaseScraper):
    """Scraper for Au Fil du Thym."""

    def __init__(self):
        super().__init__(
            base_url="https://aufilduthym.fr/category/recettes/recettes-du-potager/",
            name="Au Fil du Thym"
        )
